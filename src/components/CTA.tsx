  ...
  return (
    <section id="consultation" className="py-24 px-4 sm:px-6 lg:px-8">
      <motion.div
        ...
        className="max-w-7xl mx-auto relative rounded-[3rem] overflow-hidden bg-brand-dark min-h-[500px] flex items-center justify-center p-8 text-center"
      >
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/2 left-10 w-32 h-32 bg-brand-blue/20 blur-3xl rounded-full"></div>
        <div className="absolute top-1/4 right-0 w-48 h-48 bg-brand-purple/10 blur-3xl rounded-full"></div>
      </motion.div>
    </section>
  );
}
